# Next.js v14.2 Development Environments

This directory contains multiple Docker configurations for Next.js v14.2 development, each optimized for different use cases.

## Available Configurations

### 1. Core (`/core`)
- **Purpose**: Minimal Next.js v14.2 setup
...
### Using Core Image
```bash
docker build -t nextjs-v14.2-core ./core
docker run -it -p 3000:3000 -v $(pwd):/workspace nextjs-v14.2-core
```

### Using with Gitpod
Add to `.gitpod.yml`:
```yaml
image: ghcr.io/w3dev/dev-workspaces/nextjs:v14.2-gitpod
```

### Using Code-Server
```bash
docker build -t nextjs-v14.2-code-server ./code-server
docker run -d -p 8080:8080 -p 3000:3000 nextjs-v14.2-code-server
...
- [Next.js v14.2 Documentation](https://nextjs.org/docs)
- [Next.js v14.2 Release Notes](https://nextjs.org/blog/next-15)
- [Migrating to v14.2](https://nextjs.org/docs/app/guides/upgrading/version-15)