# Next.js v15 Development Environments

This directory contains multiple Docker configurations for Next.js v15 development, each optimized for different use cases.

## Available Configurations

### 1. Core (`/core`)
- **Purpose**: Minimal Next.js v15 setup
...
### Using Core Image
```bash
docker build -t nextjs-v15-core ./core
docker run -it -p 3000:3000 -v $(pwd):/workspace nextjs-v15-core
```
...
### Using Code-Server
```bash
docker build -t nextjs-v15-code-server ./code-server
docker run -d -p 8080:8080 -p 3000:3000 nextjs-v15-code-server
...
- [Next.js v15 Release Notes](https://nextjs.org/blog/next-15)
- [Migrating to v15](https://nextjs.org/docs/app/guides/upgrading/version-15)